...
function init() {
  var injects = __webpack_require__("./injects sync [A-Za-z0-9-_]+\\.ts$");

  ctx.injects = injects.keys().map(function (key) {
    return injects(key).default;
  });
  $log("init");
  ...
  try {
    for (var _iterator = ctx.injects[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var i = _step.value;
...
function register(mode) {
  if (mode === "subwindow" || mode === "all") {
    ...
    if (unsafeWindow.parent !== unsafeWindow) {
      if (!unsafeWindow.$name) {
        ctx.name = lodash__WEBPACK_IMPORTED_MODULE_9___default.a.uniqueId("subWindow_");
        unsafeWindow.$name = ctx.name;
        ctx.parentWindow = unsafeWindow.parent;
        $log("iframe '".concat(ctx.name, "'(").concat(unsafeWindow.document.title, ") registered"));
  ...
  if (mode === "top" || mode === "all") {
    if (!unsafeWindow.$name) {
      ctx.name = lodash__WEBPACK_IMPORTED_MODULE_9___default.a.uniqueId("top_");
      unsafeWindow.$name = ctx.name;
      ctx.parentWindow = unsafeWindow;
      $log("top '".concat(ctx.name, "'(").concat(unsafeWindow.document.title, ") registered"));
      ctx.parentWindow.postMessage({
        type: "M_SCRIPT_INIT",
        source: ctx.name
      }, "*");
...
/***/ "./injects sync [A-Za-z0-9-_]+\\.ts$":
/*!*******************************************************!*\
  !*** ./injects sync nonrecursive [A-Za-z0-9-_]+\.ts$ ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

var map = {
	"./__main__.ts": "./injects/__main__.ts",
	"./bilibili_live.ts": "./injects/bilibili_live.ts",
	"./hololive_schedule.ts": "./injects/hololive_schedule.ts"
};
...
webpackContext.id = "./injects sync [A-Za-z0-9-_]+\\.ts$";
...
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../index */ "./index.ts");
...
function _request() {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(xhr) {
        ...
        switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt("return", new Promise(function (resolve, reject) {
              ...
              GM_xmlhttpRequest(_objectSpread({}, xhr, {
...
function _getUserInfo() {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee2(uid) {
    var data;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return request({
              method: "GET",
              url: "https://api.bilibili.com/x/space/acc/info?mid=".concat(uid)
            });
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return request({
              method: "GET",
              url: "https://api.live.bilibili.com/room/v1/Room/getRoomInfoOld?mid=".concat(uid)
            });
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            if (!(_typeof(e.data.data) !== "object")) {
              _context4.next = 11;
              break;
            }

            _context4.t0 = postMessage;
            _context4.t1 = _index__WEBPACK_IMPORTED_MODULE_17__["ctx"].name;
            _context4.next = 7;
            return getUserInfo(e.data.data);
          ...
          case 7:
            ...
            _context4.t4 = e.origin;
            (0, _context4.t0)(_context4.t3, _context4.t4);
          ...
          case 13:
            ...
            _context4.t5 = postMessage;
            _context4.t6 = _index__WEBPACK_IMPORTED_MODULE_17__["ctx"].name;
            _context4.next = 19;
            return getLiveInfo(e.data.data);
          ...
          case 19:
            ...
            _context4.t9 = e.origin;
            (0, _context4.t5)(_context4.t8, _context4.t9);
          ...
          case 25:
            ...
            console.error(_context4.t10);
            postMessage({
              type: "M_ERROR",
              source: _index__WEBPACK_IMPORTED_MODULE_17__["ctx"].name,
              data: _context4.t10 ? _context4.t10.message || _context4.t10 : "Unknow error"
            }, e.origin);
...
/* harmony import */ var _index__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../index */ "./index.ts");
...
var moduleName = "holo schedule";
/* harmony default export */ __webpack_exports__["default"] = ({
  test: /schedule\.hololive\.tv\/simple/,
  mode: "subwindow",
  inject: function inject() {
    var promotion = document.querySelector(".navbar.promotion-header");

    if (promotion) {
      promotion.style.display = "none";
      Object(_index__WEBPACK_IMPORTED_MODULE_4__["$log"])("已移除宣传header");
    }

    if (_index__WEBPACK_IMPORTED_MODULE_4__["ctx"].parentWindow) {
      var videoLinks = document.querySelectorAll(".tab-pane a");
      videoLinks.forEach(function (a) {
        if (a.target === "_blank") {
          a.onclick = function () {
            Object(_index__WEBPACK_IMPORTED_MODULE_4__["$log"])("已拦截油管链接跳转");
            _index__WEBPACK_IMPORTED_MODULE_4__["ctx"].parentWindow.postMessage({
              type: "M_OPEN_U_LINK",
              source: _index__WEBPACK_IMPORTED_MODULE_4__["ctx"].name,
              data: {
                url: a.href,
...
/******/ });
//# sourceMappingURL=ddhelper.user.js.map